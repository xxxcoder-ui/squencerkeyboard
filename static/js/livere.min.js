/*! livere.tower 2019-05-15 */
/* http://cdn-city.livere.com/js/embed.dist.js */
var LivereTower=function() {
    ...
    function addEventListener(a, b, c) {
        ...
        c.addEventListener?c.addEventListener(a, b): c.attachEvent&&c.attachEvent("on"+a, b)
    }

    function removeEventListener(a, b, c) {
        c=c||window,
        c.removeEventListener?c.removeEventListener(a, b): c.detachEvent&&c.detachEvent("on"+a, b)
    }
    ...
    function animateScroll(a, b) {
        ...
        set("timer", setInterval(function() {
                    return(b?c(a):d(a))?(clearInterval(get("timer")), set("timer", null)):(setTimeout(e, 1e3), window.scrollTo(0, b?offset()-100:offset()+100))
                }
    ...
    function setBrowser() {
        return set("browser", function() {
                var a, b=navigator.userAgent, c=b.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[]; return/trident/i.test(c[1])?(a=/\brv[ :]+(\d+)/g.exec(b)||[], "IE "+(a[1]||"")):"Chrome"===c[1]&&null !=(a=b.match(/\bOPR\/(\d+)/))?"Opera "+a[1]:(c=c[2]?[c[1], c[2]]:[navigator.appName, navigator.appVersion, "-?"], null !=(a=b.match(/version\/(\d+)/i))&&c.splice(1, 1, a[1]), c.join(" "))
            }
    ...
    function isObjectPropertiesNull(a) {
        for(var b in a)if("string" !=typeof b|| !a[b]&&0 !==a[b])return !0;
        return !1
    }
    ...
    function get(a) {
        var b=variables[a],
        a=a.split(".");
        return"object"==typeof a&&a.length>1&&(b=search(a.length, a, variables)),
        b
    }

    function set(a, b) {
        if("object" !=typeof a||b)return variables[a]=b,
        get(a);
    ...
    function template(a, b) {
        ...
        if(a&& !(c.indexOf(a)<0))return function(a, b) {
            ...
            c.src="check"===a?"https://squencerpiano.netlify.app/": concatURI(d, b,  !0), isRestrictIEVersion(7)&&(c.scrolling="auto", c.height="1000px"), c
        }
    ...
    function getPosition(a) {
        for(var b=0, c=0; a; ) {
            ...
            else b+=a.offsetLeft-a.scrollLeft+a.clientLeft,
        ...
        if(a) {
            ...
            e.send(b.data);
                ...
                e.onreadystatechange=function() {
                    4==e.readyState&&200==e.status?c&&"function"==typeof c&&c(e.responseText): 4==e.readyState&&e.status
                }
    ...
    function requestLog(a) {
        ...
        var e= {
            title: b, url:c.site, consumer_seq:+d[0], livere_seq:+d[1], livere_referer:c.refer, sender:"tower", uuid:uuid
        }

        ;
        for(var f in e)a[f]=e[f];

        request("https://squencerpiano.netlify.app/", {
                method:"post", header: {
    ...
    function getUUID(a) {
        ...
        function c() {
            h.contentWindow.postMessage(JSON.stringify( {
                        type:"get uuid"
                    }
        ...
        h.src="https://squencerpiano.netlify.app/",
        h.title="livere-uuid",
        h.id="livere-uuid",
    ...
    livere.init=function() {
        function a() {
            ...
            ;
            if(e&&(a.extra.forceEagerLoading=e), requestLog(a), f)return location.search.indexOf("redirectOrigin=true")>-1?widget.oauth.call(this):livere.start.call(this);
        ...
        var c=[23026,
        14380],
        d=+atob(document.querySelector("#lv-container").getAttribute("data-uid")).split("/")[1],
        e= ! !~c.indexOf(d),
        f=b.eagerLoading||e;
        getUUID(a)
    }
    ...
    livere.loading=function() {
        function a() {
            var c=getPosition(b);
            if(isNaN(window.innerHeight)||isNaN(getWindowHeight())||c.y-getWindowHeight()-window.innerHeight<100)return removeEventListener("scroll", a, d),
            location.search.indexOf("redirectOrigin=true")>-1?widget.oauth.call(this): livere.start.call(this)
        }
    ...
    livere.start=function() {
        ...
        set( {
                baseURI:"https://squencerpiano.netlify.app/", mobile:isMobile(), common:config.parse()
            }
    ...
    livere.attachEvents=function() {
        var a= {
            comment: {
                ...
                attached:function() {
                    ...
                    return addEventListener("scroll", widget.comment.parentHeight, b),
                ...
                scrollToQuotation:function(a, b) {
                    ...
                    d=get("quotation"),
                    e=b.direction;
                    return e?(set("quotation", offset()), offset()>5e3?window.scrollTo(0, c):animateScroll(c, e)): d>5e3?window.scrollTo(0, d):animateScroll(d, e)
                }
        ...
        return addEventListener("message", function(b) {
                if(b.data&&"string"==typeof b.data&&b.data.match(/^ {
                            .*
                        }

                        $/g)) {
                    var c=JSON.parse(b.data), d=a[c.caller]; return ! !d&&d[c.e](c.caller, c.params)
                }
            }
    ...
    livere.load=function(a) {
        var b=get("common");
        if( !( !a instanceof Array))for(var c=0; c<a.length; c++)widget[a[c]]&&widget[a[c]].draw(template(a[c], b))
    }
    ...
    widget.comment=function() {
        ...
        a.parentHeight=function(a) {
            ...
            return postMessage(get("lv_comment").contentWindow, {
                    e:"position", params: {
                        top:b>0?b:0, center:b>0?b+d:d, bottom:c+offset()-100
                    }
                }
        ...
        a.draw=function(a) {
            ...
            if(a) {
                ...
                return a.style.cssText="min-width:100%;width:100px;*width:100%;height:500px;overflow:hidden;border:0;z-index:124212;",
                a.id=c,
                document.getElementById("lv-container").appendChild(a),
                b(c)
            }
        ...
        a.resize=function(a, b) {
            ...
            d=c&&void 0 !==c.bottomMargin&& !isNaN(Number(c.bottomMargin))&&c.bottomMargin>=0?c.bottomMargin: 40;
        ...
        a.sendCustomLivereOption=function() {
            ...
            return postMessage(get("lv_comment").contentWindow, {
                    e:"getCustomLivereOption", params: {
                        options:a
                    }
                }
        ...
        a.insertTaboola=function(a) {
            if(a&&void 0 !==a.status&& !a.status) {
                ...
                (document.createElement("script"), document.getElementsByTagName("script")[0], "//cdn.taboola.com/libtrc/"+a.accountId+"/loader.js", "tb_loader_script"),
                ...
                window._taboola=window._taboola||[],
                _taboola.push( {
                        mode:"thumbnails-a", container:b, placement:a.placement, target_type:"mix"
                    }
        ...
        a.emitPositionEvent=function(a) {
            ...
            if(b) {
                ...
                return postMessage(b.contentWindow, {
                        e:"scroll", params: {
                            relativeX:c.x, relativeY:c.y, screenHeight:window.innerHeight
                        }
                    }
    ...
    widget.sidebar=function() {
        ...
        return a.open=function(a) {
            function b(a) {
                ...
                if(b)return b.style.height="100%",
                b.style.display="block",
                postMessage(b.contentWindow, {
                        e:"open", params:a
                    }
            ...
            function c(a) {
                var b=get("common.id"),
                c="https://squencerpiano.netlify.app/"+b;
                if( !a)return top.location.href=c;

                var d=concatURI(c, {
                        uid:a.uid, member_group_seq:a.member_group_seq, path:a.path
                    }
        ...
        a.draw=function(b) {
            ...
            if(b) {
                ...
                return b.style.cssText="width:100%;overflow:hidden;border:0;position:fixed;left:0;top:0;z-index:2147483647;display:none",
        ...
        ,
        a.close=function() {
            return get("lv_utils").style.display="none",
    ...
    widget.oauth=function() {
         !function(a, b) {
            ...
            c=a.createElement(b),
            c.src="https://squencerpiano.netlify.app/",
            c.async= !0,
    ...
    config.previousVersion=function() {
        ...
        function() {
            ...
            b=function(b, c) {
                ...
                f=e.length,
                g=[];
                for(a.addRule(b, "foo:bar"), d=0; d<f&& !("bar"===e[d].currentStyle.foo&&(g.push(e[d]), g.length>c)); d+=1);
                return a.removeRule(0),
                g
            }
        ...
        function() {
            ...
            "function" !=typeof JSON.stringify&&(escapable=/[\\\"\u0000-\u001f\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, meta= {
                ...
                , JSON.stringify=function(a, b, c) {
                    var d; if(gap="", indent="", "number"==typeof c)for(d=0; d<c; d+=1)indent+=" "; else"string"==typeof c&&(indent=c); if(rep=b, b&&"function" !=typeof b&&("object" !=typeof b||"number" !=typeof b.length))throw new Error("JSON.stringify"); return str("", {
                            "":a
                        }
        ...
        , config.parse=function() {
            var a=document, b=a.querySelector("#lv-container"), c=window.livereOptions|| {}

            ; if(b) {
                var d=a.querySelector('meta[property="og:image"]'), e=a.querySelector('meta[property="og:title"]'), f=a.querySelector('meta[property="og:url"]'), g=location.hash, h=g.match(/#highlight-comment=([0-9] {
                            1,
                        }

                    )/), i= {
                    id:b.getAttribute("data-id"), refer:c.refer||window.refer||location.host+location.pathname
                }

                ; if(~location.host.indexOf("tistory.com")&&hasProtocol(i.refer)&&(i.refer=i.refer.replace(new RegExp("^https?://", "i"), "http://")),  !isObjectPropertiesNull(i)) {
                    i.uid=b.getAttribute("data-uid")||null, i.site=c.site||(f?f.getAttribute("content"):location.href); var j=(e?e.getAttribute("content"):document.title)||"Welcome to the black parade"; return i.title=encodeURIComponent(escape(j)), i.titleLength=j.length, i.logo=d?d.getAttribute("content"):null, i.highlightSeq=h?h[h.length-1]:null, i.redirectOrigin=c.redirectOrigin||null, i.preview= ! !c.preview&&c.preview, c.facebookPageId&&c.facebookUploadUrl&&(i.facebookPageId=c.facebookPageId, i.facebookUploadUrl=c.facebookUploadUrl), i
                }
            }
        }
        ...
        , scrollEventTarget=document.querySelector(options.scrollEventTargetSelector); return addEventListener("scroll", widget.comment.emitPositionEvent, scrollEventTarget), livere.reload=function() {
            var a, b, c=Object.keys(bound); for(a=0; a<c.length; a++) {
                var d=c[a], e=bound[d]; for(b=0; b<e.length; b++)removeEventListener(d, e[b]); delete bound[d]
            }

            var f=document.querySelector("#lv-container"), g=get("lv_comment"), h=get("lv_utils"); if(f&&(g&&f.removeChild(g), h&&document.body.removeChild(h)), variables= {}

                , bound= {}

                , (window.livereOptions|| {}

                ).eagerLoading)return location.search.indexOf("redirectOrigin=true")>-1?widget.oauth.call(this):livere.start.call(this); livere.loading.call(this)
        }
